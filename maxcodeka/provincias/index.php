...
<html>
	<head>
		...
		function imprimir() {
			...
			window.open("../fpdf/imprimir_provincia.php?codprovincia="+codprovincia+"&nombreprovincia="+nombreprovincia);
		}
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
			 	...
			 	<div id="botonBusqueda">
			 	  ...
			 	  <img src="../img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonnuevaprovincia.jpg" width="118" height="22" border="1" onClick="nueva_entidad()" onMouseOver="style.cursor=cursor">
