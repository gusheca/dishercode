	...
	<body onLoad="inicio()">
				...
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">RUT</td>
				            <td width="64%"><input NAME="nif" type="text" class="cajaMedia" id="nif" size="20" maxlength="15" value="<?php echo $nif?>" readonly>
							<div style="margin:0 10px 6px 0; float:right;">N&deg; de Remito  <input style="margin:0 0 0 5px;" name="remito" id="remito" type="text" value="<?php =$remito?>"></div>
							</td>
						</tr>
						<?php $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
						    <td width="27%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<?php echo implota($fecha)?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					...
					button     : "Image1"
				         ...
				         <td width="3%">IVA</td>
				         <td width="64%"><input NAME="iva" type="text" class="cajaPequena" id="iva" size="5" maxlength="5" onChange="cambio_iva()" value="<?php echo $iva?>">%
						 <div style="margin:0 10px 6px 0; float:right;">N&deg; de Factura <input name="numfactura" id="numfactura" type="text" value="<?php =$numfactura?>"></div>
						 </td>
						</tr>
						<tr>
