				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codvendedor" type="text" class="cajaPequena" NAME="codvendedor" maxlength="3" value="<?php echo $codvendedor?>"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
						...
						<tr>
							<td>Nombre</td>
							<td><input id="nombrevendedor" name="nombrevendedor" type="text" class="cajaGrande" maxlength="20" value="<?php echo $nombrevendedor?>"></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
					</table>
