	...
	<body onload=inicio()>
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
                            ...
                            <td width="64%"><input NAME="iva" type="text" class="cajaMinima" id="iva" size="5" maxlength="5" value="<?php echo $ivaimp?>" onChange="cambio_iva()"> % <div style="margin:0 10px 6px 0; float:right;">N&deg; de Factura <input name="numfactura2" id="numfactura" type="text"></div>
							</td>
