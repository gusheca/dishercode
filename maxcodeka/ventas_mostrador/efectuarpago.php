...
<form id="formulario" name="formulario" method="post" action="guardar_cobro.php" target="frame_datos">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=2 border=0>
						...
						<tr>
							<td>Pagado</td>
						    <td><?php echo $codigomonedate?> <input NAME="pagado" type="text" class="cajaPequena" id="pagado" size="10" maxlength="10"> <img src="../img/dinero.jpg" name="Image2" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Pagado" onClick="actualizarimportedevolver()"></td>
			            </tr>
						<tr>
							<td>A devolver</td>
						...
						<?php $query_fp="SELECT * FROM formapago WHERE borrado=0 ORDER BY nombrefp ASC";
